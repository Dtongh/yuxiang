...
<?php
	...
	//web
	echo static_file('web/swiper/idangerous.swiper.css');
	echo static_file('web/swiper/idangerous.swiper.min.js');
	echo static_file('web/js/jquery.page.js');
	echo static_file('web/css/jquery.page.css');
