...
<?php
	...
	//mobile
	echo static_file('mobile/js/main.js');
	echo static_file('mobile/css/style.css');
	echo static_file('mobile/js/rem.js');
	echo static_file('mobile/swiper/swiper.min.css');
	echo static_file('mobile/swiper/swiper.min.js');
?>
<!--[if IE 6]>
	<?php
